...
// Mudar Aqui o e-mail
$email_envio = "854d285377-f768b1@inbox.mailtrap.io"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "24b4d70d87dab0"; // Senha do e-mail
...
$host_port = "2525"; // Porta do Host, geralmente 465 ou 587
...
try {
  ...
  $mail->setFrom($email_envio, "Formulário - ". $name);
